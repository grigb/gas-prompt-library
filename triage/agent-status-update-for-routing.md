...
`~/.agents/agents/blocker-engineer/agent-status-inbox/` before
answering.
...
2. Supervisor-visible copy or pointer:
   `~/.agents/agents/blocker-engineer/agent-status-inbox/{UTC_TIMESTAMP}-{PROJECT_SLUG}-{ROLE_SLUG}-status.md`
