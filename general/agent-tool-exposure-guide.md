...
1. `~/.agents/.dev/ai/research/agent-attention-optimization/INDEX.md`
2. `~/.agents/.dev/ai/research/agent-attention-optimization/phase-2-agent-attention-optimization-methodology.md`
3. `~/.agents/.dev/ai/research/agent-attention-optimization/COMMUNITY-LAUNCH-CHECKLIST.md`
4. `~/.agents/.dev/ai/research/agent-attention-optimization/ECOSYSTEM-MONITORING-PLAN.md`
5. `~/.agents/.dev/ai/research/agent-attention-optimization/AAO-TAXONOMY-MAPPING.md`
6. `~/.agents/.dev/ai/reports/2026-06-05-16-42-21Z-aao-program-steward-handoff-report.md`

The AAO knowledge base root is `~/.agents/.dev/ai/research/agent-attention-optimization/`.
...
`~/.agents/docs/browser-control/codex-browser-tool-routing.md`
...
Use `~/.agents/.dev/ai/research/agent-attention-optimization/COMMUNITY-LAUNCH-CHECKLIST.md` before public release, MCP server publication, registry submission, or community promotion. It covers GitHub presence, README quality, tool descriptions, `/llms.txt`, JSON-LD, registry order, 48-hour launch execution, and post-launch cadence.

Use `~/.agents/.dev/ai/research/agent-attention-optimization/ECOSYSTEM-MONITORING-PLAN.md` when a capability needs ongoing visibility tracking, competitor monitoring, protocol-change monitoring, AI share-of-voice baselines, or description-selection evals.
