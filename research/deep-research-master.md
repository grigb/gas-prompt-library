...
`~/.agents/docs/methodologies/research-tool-routing-method.md`.
...
**Logic Source**: `~/.agents/skills/find-skills/SKILL.md`
...
**Logic Source**: `~/.agents/skills/last30days/SKILL.md`
...
1. Read `~/.agents/skills/find-skills/SKILL.md` completely.
...
1. Read `~/.agents/skills/last30days/SKILL.md` completely.
