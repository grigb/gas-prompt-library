...
- Existing Fable review assimilation:
  `~/.agents/prompts/critical-review/assimilate-existing-fable-review.md`
- Second-pass Fable direct-edit preparation:
  `~/.agents/prompts/critical-review/prepare-fable-direct-edit-followup.md`
- Post-review gap capture follow-up:
  `~/.agents/prompts/critical-review/post-review-gap-capture-followup.md`
- Pre-Critical Review Package Stability Check:
  `~/.agents/prompts/critical-review/pre-critical-review-package-stability-check.md`
- True owner gate brief:
  `~/.agents/prompts/critical-review/true-owner-gate-brief.md`
- Artifact scoring prep:
  `~/.agents/prompts/critical-review/artifact-scoring-prep.md`
...
Use: ~/.agents/prompts/critical-review/pre-critical-review-package-stability-check.md
