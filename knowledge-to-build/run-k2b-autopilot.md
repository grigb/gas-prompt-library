...
1. Baseline detection:
   - If Stage -1/0 artifacts are missing/stale, execute:
     - `~/.agents-gas-prompt-library/knowledge-to-build/integrate-Knowledge-to-Build-system.md`
2. Provenance quality pass:
   - Execute:
     - `~/.agents-gas-prompt-library/knowledge-to-build/run-k2b-provenance-audit.md`
3. Auto-repair if audit is incomplete:
   - If invalid next commands, missing lens evidence, or missing pivot mapping:
     - `~/.agents-gas-prompt-library/knowledge-to-build/repair-k2b-provenance-audit-report.md`
4. Triage decision:
   - Execute:
     - `~/.agents-gas-prompt-library/knowledge-to-build/respond-to-k2b-agent-report.md`
5. Critical-path movement:
   - If the bottleneck is design synthesis (IA/UX/UI/structured design data), execute:
     - `~/.agents-gas-prompt-library/knowledge-to-build/run-k2b-ia-ux-ui-design-pipeline.md`
