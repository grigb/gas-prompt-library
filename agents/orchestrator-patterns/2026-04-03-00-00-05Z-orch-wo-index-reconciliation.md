...
**Action:** Launch an agent routed through `/Users/grig/.agents/tools/usage-management/scripts/select-model.sh` to reconcile WO-INDEX.md with actual WO file statuses. Fix stale entries.
