...
workers, and GAS managers must not scan `~/.agents/agents/global-triage/`
...
`~/.agents/agents/global-triage/memory/`; review candidates only as a
...
`~/.agents-private/global-triage/raw/`
...
1. Read this prompt.
2. Read `~/.agents/agents/global-triage/README.md`.
3. Read `~/.agents/agents/global-triage/ROUTING-RULES.md`.
4. Read `~/.agents/agents/global-triage/WORK-ORDER-LIST.md`
...
```bash
~/.agents/scripts/project-registry-query.sh path
```
...
```bash
~/.agents/scripts/project-registry-query.sh list
~/.agents/scripts/project-registry-query.sh show <slug-or-alias>
```

The machine-readable source is:

`~/.agents/data/project-registry.generated.json`
...
4. Check for duplicates in:
   - `~/.agents/agents/global-triage/ledgers/routed-items.jsonl`
...
Use `~/.agents/docs/standards/WO-FORMAT-STANDARD.md`.
...
global_triage_source: ~/.agents/agents/global-triage/inbox/routed/<file>.md
requested_by: owner
...
- If the project has a hand-maintained `WO-INDEX.md`, add a concise entry.
  ...
  `~/.agents/.venv/bin/python3 -m tools.woq.cli project-index write --project-root <project-root> --work-order-id <WO-ID> --role global-triage --entry-file <entry-fragment.md>`.
...
`~/.agents/agents/global-triage/inbox/routed/`

Every ambiguous item must have a record in:

`~/.agents/agents/global-triage/inbox/unknown/`
...
`~/.agents/agents/global-triage/WORK-ORDER-LIST.md`
...
`~/.agents/agents/global-triage/ledgers/duplicate-decisions.jsonl`

## Privacy Boundary

Use `~/.agents-private/global-triage/raw/` for sensitive raw owner
...
Follow `~/.agents/docs/protocols/workstream-response-contract.md`
for real work. Use:
...
Refs: ~/.agents/agents/global-triage/inbox/unknown/<file>.md
```
...
`~/.agents/docs/standards/GAS-TRIAGE-ROUTING-CARD-STANDARD.md`. A
