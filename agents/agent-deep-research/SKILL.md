...
`~/.agents/docs/methodologies/research-tool-routing-method.md` and
classify the request:

- Read and use `~/.agents/skills/find-skills/SKILL.md` when the real
  gap is discovery of an existing skill, workflow, template, or specialized
  capability.
- Read and use `~/.agents/skills/last30days/SKILL.md` when the result
