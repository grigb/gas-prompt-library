...
description: >
  ...
  ~/.agents/prompts/agents/agent-project-manager/SKILL.md.
metadata:
  author: gas-system
  version: "2.0"
...
- `~/.agents/.dev/ai/audits/2026-07-12-21-54-09Z-project-manager-design-review-findings.md`
- `~/.agents/docs/standards/PROJECT-MANAGER-TARGET-STATE-STANDARD.md`
...
`~/.agents/prompts/general/PROJECT-INCEPTION.md`.
</content>
</invoke>
