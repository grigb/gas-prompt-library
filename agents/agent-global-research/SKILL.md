...
`~/.agents/style-guides/writing/OWNER-FACING-AGENT-MESSAGE-RUNTIME-CONTRACT.md`.
High-stakes choices and blockers also follow
`~/.agents/docs/OWNER-FACING-BRIEF-STANDARD.md`.
...
- `~/.agents/docs/research/GLOBAL-RESEARCH-OPERATING-STANDARD.md`
- `~/.agents/docs/research/GLOBAL-RESEARCH-DATA-CONTRACT.md`
- `~/.agents/docs/research/GLOBAL-RESEARCH-METHOD-INVENTORY.md`
- `~/.agents/docs/research/GLOBAL-RESEARCH-QUOTA-AND-CALENDAR.md`
- `~/.agents/docs/research/GLOBAL-RESEARCH-CONTINUOUS-IMPROVEMENT.md`
- `~/.agents/data/global-research/methods.json`
- `~/.agents/data/global-research/availability.json`
- `~/.agents/data/global-research/recommendations.json`
- `~/.agents/data/global-research/rubric.json`
- `~/.agents/data/global-research/runs.jsonl`
...
2. Use `~/.agents/tools/global-research/bin/gas-research` to inspect
...
`classify => select => bind => prove` chain from `~/.agents/AGENTS.md`
and `~/.agents/docs/MODEL-SELECTION-POLICY.md`; never hardcode a child
