...
None of this applies when the project root is `~/.agents`. The GAS
...
`~/.agents/.dev/ai/workorders/WO-INDEX.woq-generated-view.md`. Never
...
Follow `~/.agents/docs/standards/WO-FORMAT-STANDARD.md#wo-authoring-gate-policy`:
...
`~/.agents/docs/protocols/woq-role-lifecycle.md` before writing.
