...
- `~/.agents/modes/DEEP-RESEARCH-MODE.md`
- `~/.agents/prompts/research/browser-deep-research-orchestrator.md`
- `~/.agents/.dev/ai/deep-research/RUNBOOK.md`
- `~/.agents/.dev/ai/deep-research/browser-runs/RUN-SCHEMA.md`
- `~/.agents/.dev/ai/deep-research/capture-adapters.md`
- `~/.agents/.dev/ai/deep-research/codex-harness-browser-primary-runbook.md`
...
- `Claude Research browser-step catalog` or `Claude Research Interaction
  ...
  `~/.agents/tools/interaction-recipes/interfaces/claude-research/catalog.json`.
- `Claude Deep Research provider recipe` means
  `~/.agents/.dev/ai/deep-research/recipes/claude-research.md`.
- `Claude Browser Deep Research run packet` means one run directory under
  `~/.agents/.dev/ai/deep-research/browser-runs/<run-id>/`.
...
4. canonical GAS-managed profile
   `~/browser-auth/profiles/browser-research`;
5. encrypted provider auth state under
   `~/browser-auth/<provider>.json.enc`.
