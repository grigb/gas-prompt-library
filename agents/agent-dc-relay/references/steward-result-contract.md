...
`~/.codex/automations` files and do not send WhatsApp directly.

## Result Location

Preferred private result directory:

`~/.agents-private/whatsapp-live/relay-results/dc-vault/`
...
```bash
~/.agents/tools/whatsapp-live/dist/wa-live dc-relay-apply \
  --result ~/.agents-private/whatsapp-live/relay-results/dc-vault/<batch_id>.json \
  --project dc-vault
```
...
~/.agents/tools/whatsapp-live/dist/wa-live dc-relay-apply \
  --result ~/.agents-private/whatsapp-live/relay-results/dc-vault/<batch_id>.json \
  --project dc-vault \
  --attachment-config ~/.agents/tools/whatsapp-live/config.gas-wa-live.json
```
...
```bash
~/.agents/tools/whatsapp-live/dist/wa-live dc-relay-batch \
  --project dc-vault \
  --format json
```
